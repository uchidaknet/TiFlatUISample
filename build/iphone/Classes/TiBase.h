...
// in simulator we redefine to format for TiFlatUI Developer console
...
{\
	NSString * exceptionName = [@"org.tiflatui." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiflatui";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITiFlatUINativeItemNone = -1, 
	UITiFlatUINativeItemSpinner = -2,
	UITiFlatUINativeItemProgressBar = -3,
	
	UITiFlatUINativeItemSlider = -4,
	UITiFlatUINativeItemSwitch = -5,
	UITiFlatUINativeItemMultiButton = -6,
	UITiFlatUINativeItemSegmented = -7,
	
	UITiFlatUINativeItemTextView = -8,
	UITiFlatUINativeItemTextField = -9,
	UITiFlatUINativeItemSearchBar = -10,
	
	UITiFlatUINativeItemPicker = -11,
	UITiFlatUINativeItemDatePicker = -12,
	
	UITiFlatUINativeItemInfoLight = -13,
	UITiFlatUINativeItemInfoDark = -14,
	
	UITiFlatUINativeItemDisclosure = -15,
	
	UITiFlatUINativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiFlatUI instances of
