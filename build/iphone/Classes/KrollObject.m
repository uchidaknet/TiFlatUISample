...
//@interface TiFlatUIObject : NSObject
//@end

@interface TiFlatUIObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiFlatUIObject class]])
		{
			for (NSString *key in [[(TiFlatUIObject*)o modules] allKeys])
			{
